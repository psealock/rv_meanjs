...
var ApplicationConfiguration = function () {
    ...
    var applicationModuleName = 'rentvitals';
...
ApplicationConfiguration.registerModule('buildings');'use strict';
// Use Applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('core');'use strict';
// Use Applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('users');'use strict';
//Setting up route
angular.module('buildings').config([
  '$stateProvider',
...
angular.module('buildings').controller('BuildingController', [
  '$scope',
  '$state',
  'Buildingservice',
...
angular.module('core').controller('HomeController', [
  ...
  function ($scope, $state, Authentication, Buildingservice) {
    ...
    $scope.search = function () {
      ...
      var search = validateSearch($scope.search), params = {
...
angular.module('core').service('Buildingservice', [
  '$http',
  function ($http) {
    var BS = this;
    this.building = {};
    ...
    this.getGeoClient = function (params) {
      return $http.get('/building', { params: params }).then(function (response) {
        return response;
      });
    };
  }
